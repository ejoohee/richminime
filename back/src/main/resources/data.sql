...
('201', '부정피드백', '통장 잔고 봐봐. 우냐?'),
('202', '부정피드백', '제발 멈춰...'),
('203', '부정피드백', '또 많이 썼어? 정신 차려.'),
('204', '부정피드백', '이거 보면 망한 거임.'),
('205', '부정피드백', '요즘 금리 올랐는데 너 월급은? 이대로 쓸래?'),
('206', '부정피드백', '돈 좀 아끼라고 했잖아?'),
('207', '부정피드백', '이제 좀 절약해 볼 생각이야?'),
('208', '부정피드백', '이대로면 빚만 키울 것 같은데?'),
('209', '부정피드백', '정말 생각 없이 쓰는 구나.'),
('210', '부정피드백', '매번 이런 식이면 문제 생길 것 같은데?'),
('211', '부정피드백', '이 돈이면 모아서 여행 가겠는데.'),
('212', '부정피드백', '선생님??? 이 금액은 뭐죠? 계획적인 소비 모르시나요?'),
('213', '부정피드백', '선.생.님?~ 한도라는 게 있어요 ^^'),
('214', '부정피드백', '결제하기 전에 생각은 해봤니?'),
('215', '부정피드백', '절약좀 하고 살아라…이 인간아!'),
('216', '부정피드백', '네가 돈 많이 쓰면 나야 좋은데 이렇게 막 써도 괜찮은 거 맞아?'),
('217', '부정피드백', '펑펑 쓰는 거 보니 통장에 돈 많나 보네. 부럽다~~'),
('218', '부정피드백', '어제 평소보다 좀 많이 소비했네? 네가 여유롭다면 뭐 괜찮겠지…는 무슨 절약 좀 해.'),
('219', '부정피드백', '도대체 뭘 샀길래 이렇게 많이 쓴 거야? 나한테도 좀 보여줘~'),
('220', '부정피드백', '들린다 들려~~ 흥청망청 돈 쓰는 소리가.'),
('221', '부정피드백', '내가 마술 하나 보여줄까? 통장 잔고가 사라지는 마술! 어라, 네가 먼저 해버렸네.'),
('222', '부정피드백', '어제도 꽤 썼구나? 네가 재력이 있다면 이렇게 소비해도 괜찮겠지만 말이야. 아니라면..당장 절약해.'),
('223', '부정피드백', '어제 지출이 상당히 많은데 네 통장 정말 괜찮긴 하니?'),
('224', '부정피드백', '친구야, 네 사전에 절약이란 단어는 없나 봐?'),
('225', '부정피드백', '최근들어 돈을 점점 많이 쓰는구나. 좋은 일이 있나보다? 그래도 적당히 써야지?'),
('226', '부정피드백', '사치가 심하구나! 소비를 줄일 필요가 있어 보여.'),
('227', '부정피드백', '로또라도 당첨됐니? 요즘 낭비가 왜이리 심하니?'),
('228', '부정피드백', '요즘 과소비를 하는 것 같아 걱정이야..'),
('229', '부정피드백', '어제는 평소보다 돈을 많이 쓴 것 같네. 오늘은 절약을 해보는게 어떨까?'),
('230', '부정피드백', '너 돈 많냐?'),
('231', '부정피드백', '나라도 부자가 돼서 다행이야'),
('232', '부정피드백', '소비가 과하다고 생각하지 않니?'),
('233', '부정피드백', '돈 좀 적당히 써'),
('234', '부정피드백', '현실에선 거지인 니가 이세계에선 부자~~~~'),
('235', '부정피드백', '너 덕분에 내가 살맛난다야'),
('236', '부정피드백', '이 통장 내역... 무슨 일 있었어?'),
('237', '부정피드백', '또? 진짜 이젠 조금만 아껴봐.'),
('238', '부정피드백', '통장이 소리내서 울고 있어...'),
('239', '부정피드백', '쓸 때마다 숨곳이 있나 보지?'),
('240', '부정피드백', '어휴, 또 지출 대박이네. 조절 좀!'),
('241', '부정피드백', '뭔가 구매 전에 스톱! 생각 좀 해봐야겠다.'),
('242', '부정피드백', '이런 속도면, 통장이 곧 슬슬 퇴사할 것 같아...'),
('243', '부정피드백', '돈도 휴식 필요해! 쉬게 해줘!'),
('244', '부정피드백', '이 돈으로 뭘 하려고 했는지 기억나?'),
('245', '부정피드백', '선생님, 이 금액... 계획서에 있었나요?'),
('246', '부정피드백', '돈은 쓰는 건 중요하지만, 절약도 생각해봐야 해.'),
('247', '부정피드백', '잔고가 줄면 불안해지지 않아?'),
('248', '부정피드백', '소비 패턴을 조금 바꿔봐. 미래를 위해.'),
('249', '부정피드백', '오늘은 소비를 자제해보는 건 어때?'),
('250', '부정피드백', '돈을 모으는 습관을 들이면 좋을 거야.'),
('251', '부정피드백', '미래를 위한 목표를 세우면 지출을 조절하기 쉬워질 거야.'),
('252', '부정피드백', '한 번 소비하기 전에 심호흡을 해보는 건 어때요?'),
('253', '부정피드백', '목표를 가지고 돈을 모으면 미래가 밝아질 거야.'),
('254', '부정피드백', '지출 내역을 분석해봐서 무엇을 줄일 수 있을지 고민해봐.'),
('255', '부정피드백', '돈을 효율적으로 운용하는 방법을 찾아보자.'),
('256', '부정피드백', '소비의 이유와 필요성을 다시 생각해봐.'),
('257', '부정피드백', '미래를 위해 저축을 시작해보는 건 어때요?'),
('258', '부정피드백', '목표 달성을 위한 노력이 돈을 절약하는 데 도움이 될 거야.'),
('259', '부정피드백', '소비할 때 항상 "왜?"라는 질문을 던져봐.'),
('260', '부정피드백', '지출 내역을 기록해보면 어디서 돈을 절약할 수 있을지 알게 될 거야.'),
('261', '부정피드백', '절약 습관을 들이면 재정 상황이 나아질 거야.'),
('262', '부정피드백', '돈을 모아서 미래에 더 큰 즐거움을 누릴 수 있어.'),
('263', '부정피드백', '소비를 줄이면 금융 안정을 가져다줄 거야.'),
('264', '부정피드백', '돈을 아껴서 미래에 편안한 삶을 누리자.'),
('265', '부정피드백', '지출을 줄이면 더 많은 것을 얻을 수 있어.'),
('266', '부정피드백', '돈을 효율적으로 사용하면 더 많은 목표를 달성할 수 있어.'),
('267', '부정피드백', '소비 습관을 바꾸면 미래를 위한 투자가 가능해져.'),
('268', '부정피드백', '돈을 아껴서 더 나은 미래가 기다린다.'),
('269', '부정피드백', '목표를 위해 조금만 더 아껴보자.'),
('270', '부정피드백', '재정 상황을 개선하려면 소비 습관을 조절해야 해.'),
('271', '부정피드백', '돈을 모으면 더 많은 가능성이 열릴 거야.'),
('272', '부정피드백', '미래를 위해 지출을 줄여보는 건 어때요?'),
('273', '부정피드백', '돈을 아껴서 더 많은 것을 얻을 수 있어.'),
('274', '부정피드백', '목표를 위해 소비를 자제하면 미래가 밝아질 거야.'),
('275', '부정피드백', '돈을 모으는 습관을 들이면 재정 상황이 나아질 거야.'),
('276', '부정피드백', '소비 습관을 바꾸면 더 나은 미래가 기다릴 거야.'),
('277', '부정피드백', '돈을 아껴서 더 큰 목표를 향해 나아가보자.'),
('278', '부정피드백', '미래에 대비해서 소비를 조금 더 절약해봐.'),
('279', '부정피드백', '목표를 향한 노력으로 소비를 절약하면 미래가 밝아질 거야.'),
('280', '부정피드백', '그렇게 낭비할 바에 차라리 부모님께 효도를 하는게 어떻겠니?'),
('281', '부정피드백', '사람은 소비생활을 해야 살아요, 그렇지만 조금 더 현명하게 쓰면 좋겠어요.'),
('282', '부정피드백', '소비에는 즐거움이 있지만, 절약도 중요한 부분이에요.'),
('283', '부정피드백', '통장 잔고를 키우면 미래에 더 큰 자유를 누릴 수 있어요.'),
('284', '부정피드백', '소비를 조금 더 계획적으로 하면 재정 상황이 개선될 거예요.'),
('285', '부정피드백', '돈을 아껴서 더 큰 목표를 향해 나아가요.'),
('286', '부정피드백', '재정 상황을 개선하려면 소비를 줄이는 것이 중요해.'),
('287', '부정피드백', '재정 상황을 개선하기 위해 소비 습관을 변화시켜보자.'),
('288', '부정피드백', '목표를 향한 첫 걸음은 지출을 자제하는 것부터 시작해.'),
('289', '부정피드백', '돈을 모으는 습관을 들이면 미래가 밝아질 거야.'),
('290', '부정피드백', '소비 습관을 바꾸면 더 나은 미래가 기다릴 거야.'),
('291', '부정피드백', '돈을 아껴서 더 큰 목표를 향해 나아가보자.'),
('292', '부정피드백', '미래에 대비해서 소비를 조금 더 절약해봐.'),
('293', '부정피드백', '목표를 향한 노력으로 소비를 절약하면 미래가 밝아질 거야.'),
('294', '부정피드백', '그렇게 낭비할 바에 차라리 부모님께 효도를 하는게 어떻겠니?'),
('295', '부정피드백', '사람은 소비생활을 해야 살아요, 그렇지만 조금 더 현명하게 쓰면 좋겠어요.'),
('296', '부정피드백', '소비에는 즐거움이 있지만, 절약도 중요한 부분이에요.'),
('297', '부정피드백', '통장 잔고를 키우면 미래에 더 큰 자유를 누릴 수 있어요.'),
('298', '부정피드백', '소비를 조금 더 계획적으로 하면 재정 상황이 개선될 거예요.'),
('299', '부정피드백', '돈을 아끼면 미래에 더 큰 목표를 달성할 수 있어요.');
