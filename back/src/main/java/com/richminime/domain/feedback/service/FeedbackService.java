...
public interface FeedbackService {
    ...
    // 관리자 권한 확인
    // 피드백 등록
    FeedbackResDto addFeedback(FeedbackReqDto feedbackReqDto, String token);

    // 피드백 수정
    FeedbackResDto updateFeedback(Long feedbackId, FeedbackReqDto feedbackReqDto, String token);

    // 피드백 삭제
    void deleteFeedback(Long feedbackId, String token);
}
